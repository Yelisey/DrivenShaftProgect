...
{
    /// <summary>
    /// Класс, отвечающий за ведомый вал с 4 отверстиями
    /// </summary>
    class DrivenShaftFor4Hole : ShaftCreator
    {
        /// <summary>
        /// Конструктор
        /// </summary>
        ...
        public DrivenShaftFor4Hole(ksDocument3D document3D, KompasObject kompas, DataContainerShaft.InformationAboutShaft drivenShaftSample) :
        ...
        protected override void CutHoles(ksSketchDefinition sketchDefinition, ksEntity entitySketch2)
        {
            ...
            var radius = _widthHole;
            var sketchEdit = (ksDocument2D)sketchDefinition.BeginEdit();
            sketchEdit.ksCircle(_outsideDiameter / 4 - 15, -_outsideDiameter / 4 + 15, radius, 1);
            sketchEdit.ksCircle(-_outsideDiameter / 4 + 15, -_outsideDiameter / 4 + 15, radius, 1);
            sketchEdit.ksCircle(-_outsideDiameter / 4 + 15, _outsideDiameter / 4 - 15, radius, 1);
            sketchEdit.ksCircle(_outsideDiameter / 4 - 15, _outsideDiameter / 4 - 15, radius, 1);
        ...
        {
            var sketchEdit = (ksDocument2D)sketchDefinition.BeginEdit(); 
            sketchEdit.ksCircle(0, 0, _outsideDiameter/4 - 35, 1);
            sketchDefinition.EndEdit();
